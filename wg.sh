...
# Tambahan
cd /usr/bin
wget -O mwg "https://raw.githubusercontent.com/ubitch69/loh/main/mwg.sh"
wget -O add-wg "https://raw.githubusercontent.com/ubitch69/loh/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/ubitch69/loh/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/ubitch69/loh/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/ubitch69/loh/main/renew-wg.sh"
wget -O port-wg "https://raw.githubusercontent.com/ubitch69/loh/main/port-wg.sh"
chmod +x mwg
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
