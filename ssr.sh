...
Install_SSR
wget -O /usr/bin/mssr https://raw.githubusercontent.com/ubitch69/loh/main/mssr.sh && chmod +x /usr/bin/mssr
wget -O /usr/bin/ssr https://raw.githubusercontent.com/ubitch69/loh/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://raw.githubusercontent.com/ubitch69/loh/main/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://raw.githubusercontent.com/ubitch69/loh/main/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://raw.githubusercontent.com/ubitch69/loh/main/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
